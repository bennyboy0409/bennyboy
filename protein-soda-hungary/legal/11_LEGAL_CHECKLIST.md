# 11 — THE MASTER LEGAL CHECKLIST

**Every legal and regulatory obligation for placing a 330 ml canned protein soda on the Hungarian market — business setup, tax, food law, labelling, DRS — in one table, in the order it has to happen.**
...
# PHASE 0 — THE FREE LETTERS. SEND THESE IN WEEK 1.

**These cost nothing, they take an hour, and every one of them unblocks a decision that could otherwise waste your entire capital. Do them before anything else.**

| # | Obligation / action | Authority | When | Cost HUF / EUR | Status | ☐ |
|---|---|---|---|---|---|---|
| 1 | **Send the five-question letter to NÉBIH**: (a) does a whey/collagen beverage need a **Reg. 853/2004 dairy-approved** filler or is 852/2004 registration enough; (b) collagen Annex III Section XV; (c) additive category 14.1.4; (d) is this a **normal food**, not a supplement; (e) may **free L-leucine and L-tryptophan** be added to a normal beverage | **NÉBIH Élelmiszer-biztonsági Igazgatóság** | **Week 1.** Allow 2–6 weeks for reply | **0 / 0** | NEEDS PROFESSIONAL CONFIRMATION | ☐ |
| 2 | **Send the 15 DRS questions to MOHU** — full text in `10_DRS_REPONT.md` §15.3. The four that decide money: milk exclusion, the ~5,000 threshold, the 2026 fee schedule, when the deposit is payable | **MOHU** — producer contact route in `10_DRS_REPONT.md` §15.2. **No MOHU email or phone was obtained; get it from mohu.hu → Kapcsolat** | **Week 1** | **0 / 0** | NEEDS PROFESSIONAL CONFIRMATION | ☐ |
| 3 | **Ask the competent district office**: may a **residential address / garage** be registered as a food storage establishment, and does the **whey content** pull the warehouse into the products-of-animal-origin **approval** regime? | **Járási hivatal élelmiszerlánc-biztonsági és állategészségügyi osztály** — phone them | **Week 1** | **0 / 0** | NEEDS PROFESSIONAL CONFIRMATION | ☐ |
| 4 | **Buy ONE written classification opinion** on the final ARCH F recipe: the **VTSZ/CN heading**. It settles the DRS milk-exclusion question, the ÁFA rate (27% vs 18%) and NETA scope **in one go** | Hungarian tax adviser / ügyvéd. Instrument if needed: NAV **kötelező érvényű vámtarifa-besorolás** | Before artwork | **UNKNOWN — QUOTE REQUIRED** | NEEDS PROFESSIONAL CONFIRMATION | ☐ |

> **Items 1–3 are free. Item 4 is the highest-leverage professional spend in the project. Nothing else in this file is worth as much per forint.**

---

# PHASE 1 — THE LEGAL VEHICLE (WEEKS 1–2)
...
| 9 | **Cégkapu registration** — mandatory for every *gazdálkodó szervezet* since 2018-01-01. **Egyéni vállalkozók are NOT required to have one** | `https://tarhely.gov.hu/ckp-regisztracio/tajekoztato.html` | On formation | **0 / 0** | LIKELY REQUIREMENT (companies) | ☐ |
| 10 | **Domestic *pénzforgalmi számla*** — mandatory for any company, and for a VAT-liable EV, **within 15 days of the tax number**. ⚠️ **Revolut / Wise alone likely do NOT satisfy the domestic-account requirement.** Penalty up to **200,000 HUF** (natural person) / **500,000 HUF** (other) | Any Hungarian bank. Cheapest found: **Gránit Bank Vállalkozói KamatPlusz, 0 HUF/month unconditional** | **Within 15 days of tax number** | **0 / 0** (Gránit) | LIKELY REQUIREMENT — Revolut/Wise point **NEEDS PROFESSIONAL CONFIRMATION** | ☐ |
| 11 | **Chamber registration + annual contribution 5,000 HUF.** Registration is not membership; membership stays voluntary. New businesses: register **within 5 working days** of starting | **MKIK** — `https://knyr.mkik.hu/`. Account **12100011-10639683** (Gránit); put the 11-digit tax number in the reference | Register on start; **pay by 31 March each year** | **5,000 / 13.77 per year** | **CONFIRMED REQUIREMENT** (the 5-working-day registration deadline NEEDS PROFESSIONAL CONFIRMATION) | ☐ |
| 12 | **Minor's employment contract** (16+, or 15 in school holidays if in full-time education) with **legal representative's consent** | **Mt. 34. §** | Before the minor does paid work | **0 / 0** | LIKELY REQUIREMENT | ☐ |
| 13 | **Engage a bookkeeper on a WRITTEN scope**: monthly ÁFA, monthly ’A60 recapitulative, quarterly EPR, annual TAO/KIVA, annual HIPAK, annual beszámoló. **Do not accept a headline "from 30,000 HUF" without this list.** Double-entry bookkeeping is mandatory for companies | Market | Week 2 | **30,000–70,000 / 83–193 per month** for a micro Kft.; **EV 17,000–35,000 / 47–96** | LIKELY REQUIREMENT — **the single largest recurring cost in the whole stack** | ☐ |

---

# PHASE 2 — TAX REGISTRATIONS AND ELECTIONS
...
| 18 | **Invoice content per Áfa tv. 169. §** — issue date, unique sequential number, seller name/address/tax number, buyer name/address (+tax number where required), date of supply, description and quantity, net unit price and taxable amount, VAT rate, VAT amount, and any statutory wording | NAV | Every invoice | **0 / 0** | **CONFIRMED REQUIREMENT** | ☐ |

---

# PHASE 3 — FOOD LAW: BEFORE A SINGLE CAN EXISTS

| # | Obligation | Authority | When | Cost HUF / EUR | Status | ☐ |
|---|---|---|---|---|---|---|
| 19 | **Check whether the entity already holds a FELIR azonosító.** An existing family company may already have one | NÉBIH — public FELIR search, **URL UNKNOWN, verify** | Before filing anything | **0 / 0** | — | ☐ |
| 20 | **Secure the storage address and confirm it may lawfully hold food stock** — landlord, *társasházi SZMSZ*, zoning. **Fallback if blocked: co-packer-held stock or a 3PL with its own food-establishment registration** — converts a fixed cost into a per-unit one | Landlord / önkormányzat / járási hivatal | Before #21 | **0 / 0** | **NEEDS PROFESSIONAL CONFIRMATION** — see #3 | ☐ |
| 21 | **FOOD-BUSINESS NOTIFICATION + establishment registration → FELIR azonosító issued.** Required by **Reg. (EC) 852/2004 Art. 6(2)**. The FELIR number is issued automatically as a consequence — it is not a separate application | **Járási / vármegyei hivatal élelmiszerlánc-biztonsági osztály**; `https://portal.nebih.gov.hu/hu/egyeb-bejelentes` — **exact form name UNKNOWN** | **BEFORE starting the activity.** Allow **2–4 weeks** | **0 / 0** | **CONFIRMED REQUIREMENT** that a food business registers. **The route for a non-manufacturing brand owner NEEDS PROFESSIONAL CONFIRMATION** | ☐ |
| 22 | **Determine notification vs approval** under **57/2010 FVM r.**, given the whey and collagen content. **Ask this during #21 — it is free and it is the highest-value open item in food law** | Same authority | At #21 | **0 / 0** | **NEEDS PROFESSIONAL CONFIRMATION** | ☐ |
| 23 | **Commercial-activity notification to the jegyző**, if required — **210/2009. (IX. 29.) Korm. rendelet** | **Jegyző** of the municipality; `https://njt.hu/jogszabaly/2009-210-20-22` | 1–3 weeks, before trading | **~3,000 / ~8.26** | **NEEDS PROFESSIONAL CONFIRMATION** — whether wholesale/D2C without a physical shop triggers it was flagged as genuinely open | ☐ |
| 24 | **HACCP-based procedures and Good Hygiene Practice (GHP).** **Reg. 852/2004 Art. 5(1)** applies to storage and distribution — there is **no blanket exemption for distributors**. For sealed shelf-stable cans the intended route is the **national GHP guide for *kereskedelem***, adapted to your premises, plus records. Must cover: product description, flow diagram, hazard analysis, goods-in acceptance, FEFO rotation, pest control, cleaning, training records, traceability and recall annexes | Self, from the NÉBIH national guide (`portal.nebih.gov.hu` — **exact URL UNKNOWN**) | Before storing stock | **Guide expected 0**; consultant **UNKNOWN — QUOTE REQUIRED**. **Self-drafting is a legitimate route for a storage-only operation** | **CONFIRMED REQUIREMENT** that procedures exist | ☐ |
| 25 | **Traceability, one step back / one step forward — Reg. (EC) 178/2002 Art. 18.** Inbound: supplier, date, batch/lot, best-before, quantity, invoice ref. Outbound: customer, date, **batch dispatched**, quantity, invoice ref. **The batch linkage is the single most common failure point** — if you cannot say which gyms got lot L2604, you must recall everything. **You do NOT have to trace to the final consumer** | Self | From the first delivery | **0 / 0** — **one spreadsheet, two tabs (IN / OUT), a batch column, backed up, is fully compliant. No software required** | **CONFIRMED REQUIREMENT** | ☐ |
| 26 | **Written withdrawal / recall procedure — Reg. 178/2002 Art. 19.** The duty bites **"immediately"**. Must name who decides, trigger criteria, immediate freeze, batch identification, **a customer contact list with phone numbers**, the authority notification channel, consumer communication, reconciliation, root cause. **You do NOT file RASFF yourself** — you notify NÉBIH and they escalate | Self; NÉBIH notification channel **UNKNOWN — verify BEFORE the first sale** | Before the first sale | **0 / 0** | **CONFIRMED REQUIREMENT** | ☐ |
| 27 | **Confirm the product is a NORMAL FOOD, not an *étrend-kiegészítő*.** The decisive test is **dose form** — a 330 ml RTD beverage is not a measured small quantity. **Consequence: NO pre-market product notification and NO product registration fee.** Protect this with disciplined marketing language | Food lawyer / NÉBIH (part of #1) | Before launch | **0 / 0** if normal food. Supplement route would add an **OGYÉI notification, fee UNKNOWN** | **LIKELY REQUIREMENT — no notification.** Expected outcome, not guaranteed | ☐ |
| 28 | **Retention of traceability records.** EU guidance is tiered to shelf life; Hungarian accounting law separately requires **8 years** for accounting documents | Self | Ongoing | **0 / 0** | **NEEDS PROFESSIONAL CONFIRMATION** — **default to 5 years for traceability records; it costs nothing** | ☐ |

---

# PHASE 4 — BEFORE THE SLEEVE ARTWORK GOES TO PRINT. **THIS PHASE IS IRREVERSIBLE.**

> **The shrink sleeve is printed once, before filling. Printed cans are not an option at your scale (150,000–250,000 unit minimums; Rhodius published minimum 250,000). Every decision in this phase is baked into the run.**

| # | Obligation | Authority | When | Cost HUF / EUR | Status | ☐ |
|---|---|---|---|---|---|---|
| 29 | 🔴 **THE DRS DECISION. Stay under ~5,000 cans in the calendar year → NO DRS MARK ON THE ARTWORK.** Below the ceiling: no 50 HUF deposit, no MOHU registration, no 45-day gate, no deposit float. **Above it, DRS is mandatory and there is no retrofit.** Full analysis in `10_DRS_REPONT.md` | MOHU (450/2023. (X. 4.) Korm. r.) | **BEFORE the sleeve goes to print** | **0 / 0** under the ceiling | **NEEDS PROFESSIONAL CONFIRMATION** of the ~5,000 threshold — **LIKELY, not confirmed. Get it in writing before printing** | ☐ |
| 30 | **Install a hard unit counter from can #1. Stop at 4,500 cans per calendar year.** The 10% buffer exists because it is unknown whether the count is per calendar year or rolling, whether it aggregates SKUs, and whether crossing bites **retrospectively** | Self — a column in the #25 spreadsheet | From can #1 | **0 / 0** | Operational control | ☐ |
| 31 | **Reserve a DRS-mark zone and an RVM-grade barcode zone in layout v1 anyway** — even though batch 1 carries no mark. Costs nothing now; makes version 2 a re-export instead of a redesign | Designer brief | Layout v1 | **0 / 0** | Free insurance | ☐ |
...
# PHASE 5 — PRODUCTION AND PRE-LAUNCH
...
# PHASE 6 — BEFORE THE FIRST CAN IS SOLD

| # | Obligation | Authority | When | Cost HUF / EUR | Status | ☐ |
|---|---|---|---|---|---|---|
| 50 | **EPR registration.** Route: **Ügyfélkapu/DÁP → *meghatalmazás* → KÜJ number → OKIRkapu → data package KG: KGYF-NY**. Pre-registration on the MOHU site (`https://mohu.hu/pdf/EPR-regisztracio.pdf`; `https://epr.hu/epr-regisztracioval-kapcsolatos-informaciok`). **Applies to the CAN while you are under the DRS ceiling, and to shipper cartons and film ALWAYS** | MOHU / OKIRkapu | **Before the first placing on market** | **0 to register.** Fee ≈ **2.42–2.79 HUF/can** (metal V01 186 HUF/kg) **+ ~2.52 HUF/can** carton (P01 173 HUF/kg) = **~8,704 HUF ≈ EUR 24 on batch 1** | **LIKELY REQUIREMENT** | ☐ |
...
# PHASE 7 — RECURRING, FOREVER

| # | Obligation | Authority | When | Cost HUF / EUR | Status | ☐ |
|---|---|---|---|---|---|---|
| 55 | **ÁFA return.** A company with no legal predecessor is on **MONTHLY** VAT returns in its formation year **and the following business year** | NAV | Monthly | In the bookkeeping fee | **CONFIRMED REQUIREMENT** | ☐ |
| 56 | **’A60 recapitulative statement** — monthly, where there are intra-EU acquisitions (i.e. any non-Hungarian co-packer or supplier) | NAV | Monthly | In the bookkeeping fee | LIKELY REQUIREMENT | ☐ |
| 57 | **EPR quarterly data return via OKIRkapu, by the 20th of the month after quarter-end.** OKIR forwards to MOHU by the 25th; **MOHU invoices, payable within 15 days**. **Fines for EPR non-compliance were increased alongside the October 2025 rate rise — exact amounts UNKNOWN** | OKIRkapu / MOHU | **Quarterly, by the 20th** | Fee ≈ EUR 24/yr on batch 1 | **CONFIRMED REQUIREMENT** (mechanism); 2026 dates LIKELY | ☐ |
| 58 | **Chamber contribution 5,000 HUF** | MKIK — `https://knyr.mkik.hu/` | **By 31 March, every year** | **5,000 / 13.77** | **CONFIRMED REQUIREMENT** | ☐ |
| 59 | **HIPA annual return, form 26HIPAK** | Municipal tax authority (payment goes to the **municipality**, not NAV) | **End of May** (LIKELY — confirm with the bookkeeper) | ≈**50,000 / 138** (ESTIMATE, banded base) | LIKELY REQUIREMENT | ☐ |
| 60 | **Annual report (*beszámoló*)** — the **mikrogazdálkodói egyszerűsített éves beszámoló** is the lightest and cheapest form. **A single upload satisfies both publication and deposit.** Missing it escalates to tax-number suspension and ultimately deletion of the company | Ministry of Justice — `e-beszamolo.im.gov.hu` | **By 31 May** (last day of the 5th month after the balance-sheet date) | **0 / 0** | **CONFIRMED REQUIREMENT** | ☐ |
| 61 | **Élelmiszerlánc-felügyeleti díj declaration.** **0.1% of the PREVIOUS year's net food-chain revenue → year 1 = 0 HUF.** ⚠️ **A declaration duty may exist even where the fee is zero — ask whether a NIL return is required** | NÉBIH — **felugyeletidij@nebih.gov.hu · +36 1 336 9024** | Annual — **deadline UNKNOWN** | **Year 1: 0 / 0.** On batch 1 revenue thereafter: **~1,070 / ~2.95** | LIKELY REQUIREMENT — **deadline NEEDS PROFESSIONAL CONFIRMATION** | ☐ |
| 62 | **Annual mock recall** — trace one lot end to end on paper | Self | Once a year | **0 / 0** — one hour | Not a legal requirement. **It is what turns the #26 document into a capability** | ☐ |
| 63 | **Keep the DRS unit counter current and reconciled to the traceability records** | Self | Continuously | **0 / 0** | Operational control on #29 | ☐ |
...
| HIPA, year 1 (#16, #59) | ~50,000 | ~138 | ESTIMATE |
| Classification opinion (#4) | UNKNOWN | UNKNOWN | QUOTE REQUIRED |
| Product liability insurance (#54) | UNKNOWN | UNKNOWN | QUOTE REQUIRED |
| HACCP consultant (#24), if not self-drafted | UNKNOWN | UNKNOWN | QUOTE REQUIRED |
| GS1 Hungary licence (#42) | UNKNOWN | UNKNOWN | QUOTE REQUIRED |

> ### THE HONEST HEADLINE
> **The statutory fees to get batch 1 legally onto a gym shelf total about EUR 46. The professional advice and the bookkeeper do not.**
>
> **Bookkeeping alone is 1–2.3× the founder's entire EUR 1,000 personal capital.** Every structural decision should be optimised against **bookkeeping cost** and **the founder's social-contribution floor** — not against ÁFA, NETA or EPR, all of which are rounding errors at this scale.
>
> **This is also the argument for Track A — use an existing adult family company.** It already has the bookkeeper, the bank account, the Cégkapu and possibly the FELIR number. On a EUR 3,000 budget it is the difference between a launch and a paperwork exercise.
...
**Related files:** `07_HUNGARY_BUSINESS_SETUP.md` (vehicle, tax, levies in full) · `08_HUNGARY_FOOD_COMPLIANCE.md` (FELIR, HACCP, traceability, additives in full) · `10_DRS_REPONT.md` (the deposit system in full)
