...
| **Evectv. 2009. évi CXV. 3. § (2)** | Excludes a **kiskorú** from egyéni vállalkozó status. | https://njt.hu/jogszabaly/2009-115-00-00.5 ; https://net.jogtar.hu/jogszabaly?docid=a0900115.tv | SEARCH-VERIFIED — **verbatim text could not be read; re-read before filing** |
| Practitioner corroboration | *"egyéni vállalkozás vagy egyéni cég **csak 18. életévét betöltött személy** alapíthat"* | https://iriszoffice.hu/egypercesek/hany-eves-kortol-lehet-egyeni-vallalkozasom-vagy-sajat-cegem/ ; https://jogzona.hu/hany-eves-kortol-lehet-egyeni-vallalkozasom-vagy-sajat-cegem/ | SEARCH-VERIFIED |
| **Mt. 34. §** | Employment from **16**. **15** allowed if in full-time education and **only during school holidays**. Under 18 → legal representative's consent needed to conclude/modify/terminate the contract. | NAV info leaflet 72 *A diákok munkavállalása* (2026-01-15) https://nav.gov.hu/pfile/file?path=/ugyfeliranytu/nezzen-utana/inf_fuz/2026/72.-A-diakok-munkavallalasa-2026.-01.-15 ; https://ado.hu/munkaugyek/kiskoru-foglalkoztatasa-legalisan/ | SEARCH-VERIFIED |
| Under-16 in cultural / artistic / sport / **advertising** work | Requires **gyámhatóság** permission. **Relevant if you appear in your own brand's advertising and are paid for it.** | https://pbkik.hu/2019/04/26/hirek/kiskoru-foglalkoztatasa-legalisan/ | SEARCH-VERIFIED |
| Unlimited-liability positions | A minor **may not** be a **kkt. tag** or a **Bt. beltag**. | https://cegvezetes.hu/2000/09/kiskoruak-a-tarsasagban/ | SEARCH-VERIFIED |

### 1.2 The gyámhatóság question — the only thing that can add 4–6 weeks

**Open question:** does the gyámhatóság (járási hivatal gyámügyi osztály) have to approve a minor **acquiring** a Kft. üzletrész at founding, when the money is a parent's gift?

- Sources agree approval is needed to **dispose of or encumber** a minor's existing üzletrész above a threshold.
- The threshold is reported **inconsistently**: some sources say **company shares / üzletrész / értékpapír above 100,000 HUF (EUR 276)**; others say **ten times the minimum old-age pension**. Gyer. **149/1997. (IX. 10.) Korm. r.** (≈ 25. §), https://njt.jog.gov.hu/jogszabaly/1997-149-20-22 ; OTP guidance https://www.otpbank.hu/static/portal/sw/file/Tajekoztato_kiskoru_vagyonanak_terh_adott_megb_20180706.pdf
- **Status: NEEDS PROFESSIONAL CONFIRMATION.** Assume it **may** be required for a 3,000,000 HUF Kft. stake. **Budget 4–6 weeks if it is.**
- If parent and minor are on **opposing sides** of a transaction, an **eseti gyám (ad hoc guardian)** must be appointed. https://drfeketelegal.hu/uncategorized-hu/kiskoru-vagyonszerzese-mikor-kell-gyamhivatali-jovahagyas-es-mikor-szukseges-eseti-gyam/ — SEARCH-VERIFIED

> **This is a reason not to found a Kft. for batch 1.** The recommended route (existing family company, you as employee) does not touch the gyámhatóság at all.

### 1.3 EXACTLY WHAT A PARENT MUST SIGN

Print this list and take it to the meeting.

| # | Document | When | Required in which route |
|---|---|---|---|
| P1 | **Egyéni vállalkozó start-of-activity notification, in the parent's OWN name** — the minor cannot be named as the vállalkozó | at registration | Fallback route (father as EV) |
| P2 | **Ügyvezető acceptance declaration + aláírás-minta (specimen signature)** | at founding | Kft. / Bt. only |
...
- Hold a **DÁP digital identity from age 14** (with a személyigazolvány) — https://dap.gov.hu/ — SEARCH-VERIFIED (https://www.vallalkozas-okosan.hu/ugyfelkapu_dap_digitalis_allampolgar). **Digital identity is NOT legal capacity.** It lets you log into portals; it does not let you be an EV or an ügyvezető.
- **Receive and spend your wages** from the venture (Ptk. 2:12 § (2) c)).
- Do all the operational work: formulation briefs, supplier emails, gym visits, design, social, sampling. None of that requires legal capacity.

---

## 2. LEGAL FORM COMPARISON — REAL NUMBERS

### 2.1 Structural comparison

| | Egyéni vállalkozó | Bt. | Kft. | Zrt. |
|---|---|---|---|---|
| Min. capital | none | no statutory minimum | **3,000,000 HUF / EUR 8,264** | **5,000,000 HUF / EUR 13,774** |
| Capital payable at founding? | n/a | per deed | **No — cash deferrable up to 2 years** | per alapszabály |
| Lawyer mandatory? | **No** | **Yes** | **Yes** | **Yes** |
| Registration fee (illeték) | **0 HUF** | **0 HUF** (simplified) | **0 HUF** (simplified) | 50,000 HUF (EUR 138) traditional |
| Közzétételi költségtérítés | 0 | **0** (simplified) | **0** (simplified) | ~5,000 HUF (EUR 13.8) |
| Registration time | same day | **1 working day** | **1 working day** | longer |
| Liability | **unlimited personal** | beltag unlimited / kültag limited | **limited** | limited |
| **Minor eligible as** | ✗ nothing | ✗ beltag / ✓ **kültag** | ✓ **tag** | ✓ shareholder |
| Accounting | 17,000–35,000 HUF/mo | 25,000–50,000 HUF/mo | **30,000–70,000+ HUF/mo** | higher |

Sources: capital & 2-year deferral https://rozgonyiugyved.hu/szakteruleteim/tarsasagi-jog/tenyleg-kell-3-millio-forint-egy-kft-alapitasahoz/ , https://dajka-gabor.hu/kft-alapitasa-magyarorszagon-2026-ban/ — SEARCH-VERIFIED. Illetékmentes simplified procedure (Ctv. **48. §**, szerződésminta, decision in 1 working day, **no hiánypótlás — a defective filing is rejected outright**) https://www.mohos-ugyved.hu/jogi-szakteruletek/cegalapitas-koltsegei-valtozasbejegyzes-koltsegei/ , https://www.onadozo.hu/hirek/a-cegeljaras-szabalyainak-valtozasarol-3107 — SEARCH-VERIFIED. Lawyer fees https://www.cegalapitasmost.hu/cegalapitas_koltsegei.php (36,000 HUF), https://www.companyexpress.hu/cegalapitas/cegalapitas_koltsegei (50,000 HUF), https://joszaki.hu/arak/cegalapitas — PUBLIC LIST PRICE.

**Kft. share capital — the detail people get wrong.** 3,000,000 HUF is **not a cost**; it is the company's own money, and the deed may defer the cash contribution **up to 2 years**. Until it is paid: (a) the member is **personally liable up to the unpaid amount**, (b) **no dividend**, (c) the **üzletrész cannot be transferred**. Status: substance SEARCH-VERIFIED, detail NEEDS PROFESSIONAL CONFIRMATION.

### 2.2 TWELVE-MONTH CASH COST, ZERO REVENUE — the table that decides it

**ESTIMATE. Assumptions: no premises, no payroll beyond the minor, brand owner buying finished cans from a Hungarian co-packer. Accounting taken at the bottom of published ranges. Székhelyszolgáltatás 5,800 + 27% ÁFA = 7,366 HUF/mo × 12 = 88,392 HUF. Lawyer 36,000 + 27% ÁFA = 45,720 HUF.**

| Option | Founding (HUF / EUR) | Year-1 recurring (HUF) | **Year-1 total HUF** | **Year-1 total EUR** | Liability | Minor role |
|---|---|---|---|---|---|---|
| **① Existing family company** | 0 / 0 | TEÁOR addition 0 HUF; maybe +5,000 HUF/mo accounting | **0 – 60,000** | **0 – 165** | as the existing entity | ✓ employee |
| **② New EV, SECONDARY occupation** (father has a ≥36 h/week job) | 0 / 0 | 5,000 chamber + 180,000 accounting (15,000×12); contributions ≈ **0** | **≈ 185,000** | **≈ 510** | **unlimited personal** | ✓ employee |
| ③ New EV, **MAIN** occupation | 0 / 0 | 5,000 + 180,000 + **1,220,184 contributions** | **≈ 1,405,000** | **≈ 3,870** | unlimited personal | ✓ employee |
| ④ New **Bt.** | 50,720 / 140 | 5,000 + 300,000 + 88,392 seat | **≈ 444,000** | **≈ 1,223** | beltag unlimited | ✓ **kültag** |
...
- That alone consumes your entire EUR 3,000 in **under 11 months**, and your personal EUR 1,000 in **3.5 months**.

**Secondary-occupation EV (② — the fallback).** If the father already holds a **≥36 h/week employment** (or is a full-time student), there is **NO minimum contribution base**; 18.5% + 13% apply only to actual taxable income, quarterly. Sources: https://www.onadozo.hu/hirek/atalanyado-egyeni-vallalkozo-jarulekfizetese-heti-36-oras-munkaviszony-mellett-11628 ; https://accountiq.hu/blog/masodallasu-egyeni-vallalkozo-inditasa-adozasa — SEARCH-VERIFIED. **This is the single most decisive fact in the whole file.**

**Kft. "zero-contribution" configuration.** If the ügyvezető is **not a member** and serves under an **unpaid megbízási jogviszony**, no contribution liability arises. If the ügyvezető **is** a member, they are a *társas vállalkozó* and the minimum-base rules bite **unless** they hold a ≥36 h/week job elsewhere. Sources: https://adozona.hu/tb_jarulekok_nyugdij/kft_ugyvezetoje_tarsas_vallalkozo_ugyvezeto_50PXTH ; NAV info leaflet 12. Status: **NEEDS PROFESSIONAL CONFIRMATION — this is the most commonly mis-set-up item in Hungarian micro-companies and it can silently cost more than everything else combined.**

### 2.3 VERDICT

1. **Use ① — an existing adult-owned family company.** Add TEÁOR **4634** (+ **4725** for direct sales). Near-zero cost, the bank account and probably the food-business registration already exist, and you participate as employee. **This is the launch vehicle for batch 1.**
2. **If there is no family company: ② father as secondary-occupation EV** — ≈ **EUR 510/year**. Only if he genuinely has a ≥36 h/week job.
3. **Migrate to ⑤ a Kft. before the first production run that exceeds ~10,000 cans**, and buy product liability cover at the same time (§11). Not before — your capital cannot fund a Kft.'s first year **and** batch 1.
4. **Never**: minor as EV, minor as ügyvezető, minor as Bt. beltag. All legally impossible.

---

## 3. THE STEP-BY-STEP CHECKLIST

### TRACK A — Existing family company (DO THIS ONE)

| # | Action | Who | Portal / form | Cost HUF / EUR | Documents | Time | Depends on |
|---|---|---|---|---|---|---|---|
| **A1** | Pull the company's cégkivonat and read its registered activities and VAT status | **Adult** (or you — public data) | https://e-cegjegyzek.hu | **0 / 0** | company name or cégjegyzékszám | 1 day | — |
| **A2** | Add TEÁOR'25 **4634** (+ **4725**; **1107** only if contract-manufacturing in own name) | **Adult (ügyvezető)** or bookkeeper | NAV **26T201T** (companies) / **26T101E** (EV); EVs also via https://ugyfelportal.nav.gov.hu/vallalkozoi-ugyseged/main | **0 / 0** | tax number, exact code numbers from KSH | 1–3 days | A1 |
| **A3** | Confirm the company's **ÁFA status**. If it is *alanyi adómentes*, read §5 before doing anything else | **Adult** + bookkeeper | cégkivonat / NAV | 0 / 0 | — | 1 day | A1 |
| **A4** | **Food business notification + FELIR** identifier, if the company does not already hold one | **Adult** | competent **járási hivatal**; https://portal.nebih.gov.hu/hu/egyeb-bejelentes | **0 / 0** (procedure is free) | activity description, seat, product description | **2–4 weeks** | A1 — **START THIS FIRST, it is the long pole** |
| **A5** | Kereskedelmi tevékenység bejelentés to the **jegyző** under **210/2009. (IX. 29.) Korm. r.**, *if required* | **Adult** | local önkormányzat, https://njt.hu/jogszabaly/2009-210-20-22 | ~**3,000 / 8.3** general procedural fee | — | 1–3 weeks | A4. **Whether a wholesale/e-commerce-only beverage business needs this: NEEDS PROFESSIONAL CONFIRMATION** |
| **A6** | Your **employment contract** (if you are 16+), with parental consent | **You + parent** | Mt. 34. § | 0 / 0 | ID, TAJ, adóazonosító, parental consent in writing | 1 day | — |
| **A7** | **EPR registration** (KÜJ → OKIRkapu → MOHU) — see §10 | **Adult** or bookkeeper | https://mohu.hu/pdf/EPR-regisztracio.pdf ; OKIRkapu; https://epr.hu/epr-regisztracioval-kapcsolatos-informaciok | 0 to register; fee ≈ **2.4–2.8 HUF/can** | Ügyfélkapu/DÁP, meghatalmazás, KÜJ | 1–2 weeks | **before first placing on market** |
| **A8** | Product liability quote | **Adult** | Colonnade / CIG Pannónia EMABIT / Marsh / biztositson.hu (§11) | **QUOTE REQUIRED** | revenue forecast, product spec | 1–2 weeks | A4 |
| **A9** | Add the beverage scope to the bookkeeper's engagement (monthly ÁFA, EPR quarterly) | **Adult** | market | +0–5,000 HUF/mo | — | 1 week | A2 |

**Track A total realistic timeline: 3–5 weeks, gated by A4 (FELIR).**

---

### TRACK B — New egyéni vállalkozó, father, SECONDARY occupation (fallback)

| # | Action | Who | Portal / form | Cost HUF / EUR | Documents | Time | Depends on |
|---|---|---|---|---|---|---|---|
| **B1** | Obtain **DÁP** digital identity | **Father (adult)** | **https://dap.gov.hu/** | **0 / 0** | személyigazolvány | 1 day | — |
| **B2** | Submit the **start-of-activity notification** | **Father — the minor CANNOT be named** | **https://ugyfelportal.nav.gov.hu/vallalkozoi-ugyseged/main** — official guide (PDF, 2026-03-19) https://nav.gov.hu/pfile/file?path=%2Fugyfeliranytu%2Fvallalkozoknak%2Findulo-vallalkozas%2Fkapcsolodo-tartalmak%2Fa-vallalkozoi-ugyseged-utmutatoja | **0 / 0** | ÖVTJ'25 codes, seat address, tax elections | **same day** — adószám issued in the process | B1 |
| **B3** | Tax elections **in the same submission**: income-tax regime (átalányadó or vállalkozói SZJA) and **ÁFA status** | **Father** + bookkeeper | same, or NAV **26T101E** | 0 / 0 | — | same day | **B2. READ §5 FIRST — the two dossiers disagree on the ÁFA election** |
| **B4** | **Open a domestic business bank account** | **Father** | Gránit Bank Vállalkozói KamatPlusz https://granitbank.hu/vallalati-ugyfelek/bankszamlak | **0 HUF/month, unconditional** | ID, adószám, nyilvántartási szám | 1–5 days | B2. **Mandatory within 15 days of the adószám if VAT-liable** — §7 |
| **B5** | **Chamber registration + kamarai hozzájárulás** | **Father** | **https://knyr.mkik.hu/** ; MKIK acct **12100011-10639683**, reference = the **11-digit tax number** | **5,000 / 13.8 per year** | tax number | within days; **annual deadline 31 March** | B2 |
| **B6** | Engage a bookkeeper — **written scope**: monthly ÁFA, A60 if any intra-EU, quarterly EPR, annual HIPAK | **Father** | market | **17,000–35,000 / 47–96 per month** | — | 1 week | B2 |
| **B7** | **Food business notification + FELIR** | **Father** | járási hivatal / https://portal.nebih.gov.hu/hu/egyeb-bejelentes | **0 / 0** | activity description, seat | **2–4 weeks** | B2 — **long pole** |
| **B8** | Kereskedelmi bejelentés to the jegyző, if required | **Father** | önkormányzat, 210/2009. Korm. r. | ~**3,000 / 8.3** | — | 1–3 weeks | B7 |
| **B9** | **EPR registration** (KÜJ → OKIRkapu → MOHU) | **Father** | as A7 | 0 to register | Ügyfélkapu/DÁP, KÜJ | 1–2 weeks | B2, before first sale |
| **B10** | **HIPA registration** in the seat municipality | **Father** | önkormányzati adóhatóság; return on NAV **26HIPAK** | 0 to register | — | 1 week | B2 |
...
### TRACK C — New Kft. (do this LATER, not for batch 1)

| # | Action | Who | Portal / form | Cost HUF / EUR | Documents | Time | Depends on |
|---|---|---|---|---|---|---|---|
| **C1** | Instruct an **ügyvéd** (jogi képviselet is mandatory in cégeljárás). Insist on a **szerződésminta** to qualify for the **Ctv. 48. §** simplified procedure | **Adult** | market | **36,000–120,000 + 27% ÁFA = 45,720–152,400 / 126–420** | — | 1–3 days | — |
| **C2** | **Ask the lawyer in writing** whether **gyámhatóság approval** and/or an **eseti gyám** is needed for the minor to subscribe the üzletrész | **Adult** | járási hivatal gyámügyi osztály | 0 procedure fee | birth certificate, parents' ID, draft deed | **4–6 weeks IF required — schedule-critical** | C1 |
| **C3** | Secure a **székhely** (own address is free with the owner's consent) | **Adult** | e.g. https://szekhelyek.hu/ | **0**, or 5,800 + ÁFA = **7,366/mo / 20.3/mo** | ownership consent or service contract | 1 day | — |
| **C4** | Sign the létesítő okirat: **father = sole ügyvezető** (mandatory), minor = tag via törvényes képviselő, **cash contribution deferred up to 2 years** | **Adult + parent for the minor** | at the lawyer | — | IDs, adóazonosító jel, aláírás-minta | 1 day | C1, C2, C3 |
| **C5** | Electronic filing to the cégbíróság; **declare the ÁFA election in the cégbejegyzési kérelem adózási nyilatkozatai** | lawyer | — | **illeték 0, közzététel 0** | — | **decision in 1 working day; NO hiánypótlás** | C4 |
| **C6** | **Cégkapu** registration (mandatory for all gazdálkodó szervezetek since 2018-01-01; **egyéni vállalkozók are NOT required to have one**) | **Adult (ügyvezető)** | **https://tarhely.gov.hu/ckp-regisztracio/tajekoztato.html** (help https://tarhely.gov.hu/ckp-regisztracio/sugo.html) | **0 / 0** | cégjegyzékszám, ügyvezető's DÁP | 1–3 days | C5 |
| **C7** | **Bank account — mandatory within 15 days of the tax number** | **Adult (ügyvezető)** | Gránit / OTP / Raiffeisen / Erste | **0 HUF/mo (Gránit)** | cégkivonat, aláírási címpéldány, ügyvezető ID | 2–7 days | C5 |
| **C8** | NAV bejelentkezés: ÁFA status, **TAO vs KIVA**, TEÁOR codes | bookkeeper | NAV **26T201T** | 0 / 0 | — | 1 week | C5 |
| **C9** | Chamber registration + 5,000 HUF | **Adult** | https://knyr.mkik.hu/ | **5,000 / 13.8 per year** | tax number | days | C5 |
| **C10** | Bookkeeper — **double-entry mandatory** | **Adult** | market | **30,000–70,000 / 83–193 per month** | — | 1 week | C5 |
| **C11** | Food business notification + FELIR | **Adult** | járási hivatal / NÉBIH | **0 / 0** | — | 2–4 weeks | C5 |
| **C12** | EPR registration (KÜJ → OKIRkapu → MOHU) | **Adult** | §10 | 0 to register | — | 1–2 weeks | C5 |
| **C13** | **HIPA** registration in the seat municipality | **Adult** | önkormányzati adóhatóság / **26HIPAK** | 0 to register | — | 1 week | C5 |
| **C14** | Product liability insurance | **Adult** | §11 | **QUOTE REQUIRED** | revenue forecast, spec | 1–2 weeks | C5 |

**Track C timeline: 3–5 weeks without gyámhivatal; 7–11 weeks with it.**
...
|---|---|---|---|
| Soft-drink manufacturing / contract manufacturing in own name | **1107** | Üdítőital, ásványvíz gyártása | Only if you present yourself as the manufacturer |
| **Beverage wholesale — the core code for a brand owner selling to gyms and shops** | **4634** | **Ital nagykereskedelme** | **YES — mandatory** |
| Other food wholesale | **4638** | Egyéb élelmiszer nagykereskedelme | Optional |
| Mixed food/beverage/tobacco wholesale | **4639** | Élelmiszer, ital, dohányáru vegyes nagykereskedelme | Optional |
| **Beverage retail — including direct/D2C sale of the can and the webshop** | **4725** | **Ital-kiskereskedelem** | **YES for batch 1** (direct sales) |
...
**ÖVTJ'25** (sole traders) codes are 6 digits: first 4 = the TEÁOR code, last 2 = a serial number within it — e.g. **110703 Alkoholmentes (üdítő)ital gyártása** (https://www.szakmakod.hu/110703/) — SEARCH-VERIFIED.

**ACTION BEFORE FILING:** these numbers were read from mirror sites, not from the KSH master file. **Open https://www.ksh.hu/osztalyozasok_ovtj25 and https://www.ksh.hu/teaor-valtassal-kapcsolatos-tudnivalok and copy the exact numbers.** NÉBIH keeps its own list at https://portal.nebih.gov.hu/teaor-szamok-listaja.

**The code you pick also decides whether you need a cash register — see §8.** A **wholesale-only** classification keeps you outside the Pénztárgéprendelet Annex 1.

---

## 5. ÁFA — THE ONE REAL TAX DECISION, AND THE DOSSIERS DISAGREE
...
> **Status: NEEDS PROFESSIONAL CONFIRMATION.** This is a **classification question, not a marketing question**, and a wrong self-assessment produces a NAV assessment plus penalty. If your accountant thinks there is a case, the correct instrument is a NAV **kötelező érvényű vámtarifa-besorolás** (binding tariff classification) once the final recipe and VTSZ are fixed.
> **Plan every price sheet at 27%. Treat 18% as an upside you have not earned.**
...
**THE TEST THAT SETTLES IT — answer these four questions in order:**
...
## 6. IF THE CO-PACKER IS IN SLOVAKIA (OR ANYWHERE OUTSIDE HUNGARY)

Your plan targets **Hungarian** co-packers (Opre Label, Bubee). This section only bites if that changes — but it changes the ÁFA answer completely, so decide it before you elect anything.

### 6.1 Normal VAT payer with a **közösségi adószám** (the clean route)
...
If the foreign co-packer supplies a **service** (tolling / contract filling, where **you** own the liquid, the cans and the sleeves), the place of supply under **Áfa tv. 37. § (1)** is Hungary. Then:
...
> **Bottom line: whichever way a foreign co-packing deal is structured — finished goods over EUR 10,000, or a filling service at any amount — an alanyi adómentes Hungarian company pays 27% Hungarian VAT it can never get back, while still running VAT filings. The exemption buys almost nothing and costs almost everything.**

**Slovak-specific note:** the **Slovak domestic VAT rate is UNKNOWN — not researched.** Do not put a number in any model until you have it. (For reference, the dossier recorded Polish 23%, Czech 21%, Austrian 20% — **SEARCH-VERIFIED**; Slovakia was not covered.)

**ACTION IF YOU EVER GO FOREIGN: obtain the közösségi adószám BEFORE the first foreign purchase order or the first foreign service. It is a prior condition, not a follow-up filing.**
...
| Entity | Mandatory? | Rule |
|---|---|---|
| **Kft / Bt / Zrt (any gazdasági társaság)** | **YES** — at least one **domestic pénzforgalmi számla**, opened **within 15 days of the tax number** | Art. (2017. évi CL. tv.) **114. §** — https://jogkoveto.hu/tudastar/penzforgalmi-szamla-nyitasara-kotelezett-adozo — SEARCH-VERIFIED |
| **Egyéni vállalkozó, ÁFA-liable** | **YES** — same 15-day rule | https://ado.hu/ado/egyeni-vallalkozo-belfoldi-penzforgalmi-szamlanyitasi-kotelezettsege/ — SEARCH-VERIFIED |
| **Egyéni vállalkozó, alanyi adómentes** | **No legal obligation** — but banks' T&Cs normally forbid business use of a personal account | https://www.kh.hu/vallalkozas/cikkek/egyeni-vallalkozo-bankszamla — SEARCH-VERIFIED |
| **Penalty** | up to **200,000 HUF (EUR 551)** for a natural person / **500,000 HUF (EUR 1,377)** for others | same — SEARCH-VERIFIED |

> **⚠ Revolut and Wise alone are very likely NOT enough.** Sources state that fintech accounts do **not** satisfy the Art. 114 § *"belföldi pénzforgalmi számla"* requirement and must sit **alongside** a domestic bank account. **Wise Business issues a Lithuanian IBAN, not a Hungarian one.** Status: **NEEDS PROFESSIONAL CONFIRMATION**, but **plan for a Hungarian bank account regardless.** https://jogkoveto.hu/tudastar/penzforgalmi-szamla-nyitasara-kotelezett-adozo

### 7.2 Cheapest accounts (all PUBLIC LIST PRICE, 2026)

| Provider | Monthly | Notes |
|---|---|---|
| **★ Gránit Bank — Vállalkozói KamatPlusz** | **0 HUF, unconditional** (SMEs under 1 bn HUF revenue) | First **5** domestic electronic HUF transfers/month free; from the 6th **0.29%, min. 300 HUF**. Business Mastercard **0 HUF** issue + year 1, **8,000 HUF/yr (EUR 22)** from year 2. https://granitbank.hu/vallalati-ugyfelek/bankszamlak |
| Raiffeisen — Vállalkozói Aktív | **0 HUF year 1**, then ~1,756 HUF/mo (EUR 4.84) | start-up offer |
| Erste — Vállalkozói S(tart) | **0 HUF total monthly cost** | |
| OTP | **0 HUF for up to 12 months** on new business accounts | announced no fee increase from 2026-02-15 |
| Revolut Business Basic | **3,800 HUF/mo (EUR 10.47)** — no longer free | Hungarian transaction levy applies from **2026-08-31** or on migration to the Hungarian branch |
| Wise Business | **one-off 18,910 HUF (EUR 52)**, no monthly fee | **Lithuanian IBAN** — problematic for Art. 114 § |
| CIB / K&H / MBH / UniCredit | inflation-indexed **+4.4%** in 2026 | |

Sources: https://granitbank.hu/vallalati-ugyfelek/bankszamlak ; https://bankmonitor.hu/mediatar/cikk/uj-bankszamlak-es-dijmentes-csomagok-a-granit-banknal/ ; https://biztosdontes.hu/cikkek/dragulast-hozott-a-tavasz-a-vallalkozoi-szamlaknal ; comparison https://bank360.hu/vallalkozoi-bankszamla

**→ Open the Gránit Vállalkozói KamatPlusz. It is the only unconditional 0 HUF domestic business account found.**

### 7.3 Can a minor be on the account?

- **Company account:** irrelevant — the account holder is the legal person and the **adult ügyvezető** signs.
- **Personal account (14–18):** contracting requires the **legal representative's personal appearance and written consent**; statutory transaction limits apply.
- **No Hungarian bank was found offering a business account to an under-18 principal. Status: UNKNOWN — expect refusal.** Do not build a plan that depends on it.

---

## 8. INVOICING, ONLINE SZÁMLA, AND THE PÉNZTÁRGÉP — **THE MOST URGENT ITEM IN THIS FILE**

### 8.1 🚨 1 SEPTEMBER 2026 IS **16 DAYS AWAY**
...
Your plan sells batch 1 **direct / on consignment**. Those are two different answers.

| How you sell | Cash register needed? | What you do |
|---|---|---|
| **Consignment through the gym** — the gym sells to its members, you invoice **the gym** monthly for units sold | **NO** | Pure B2B on invoice. Zero hardware. **This is the structurally cheapest channel and it is already your plan.** |
| **You sell directly to a member at the gym, taking cash or card** | **YES**, unless… | …you issue a **full számla for every single can sold** from a free invoicing app on your phone. **Legal, free, and it also satisfies Online Számla.** |
| Webshop, card payment, invoice auto-issued | **NO** | invoice per order — already an invoice |

> **OPERATING RULE — write this on the wall:**
> **Phase 1 (gyms, studios, supplement stores): sell on INVOICE only. No cash register. Zero hardware cost.**
> **Phase 2 (events, direct cash sales): issue a full invoice for every single sale. Never a hand-written receipt.**
> **A certified online pénztárgép plus its annual mobile-data/service fee is a real recurring cost — amount UNKNOWN, QUOTE REQUIRED. On EUR 3,000 of capital: invoice everything and buy nothing.**
> **Do not start direct cash sales without resolving this before 1 September 2026.**

### 8.4 Online Számla real-time reporting

- **Mandatory, no value threshold.** The old 100,000 HUF and 500,000 HUF thresholds are abolished; reporting must be **immediate** ("haladéktalanul").
- **Penalties in 2026 are harsher: up to 1,000,000 HUF (EUR 2,755) PER INVOICE** for a single data error. Status: **SEARCH-VERIFIED** (professional sources; NAV's own penalty text not read).
...
| Product | Free tier | Paid entry |
|---|---|---|
| **NAV Online Számlázó** (inside `onlineszamla.nav.gov.hu`) | **0 HUF** — reports to NAV by construction | — |
| **Számlázz.hu** `#free` | **0 HUF**, unlimited invoices, NAV reporting included | `#start` ~1,700 HUF + ÁFA/mo (EUR 4.68) |
| **Billingo** Free | **0 HUF** | Basic ~1,500 HUF + ÁFA/mo (EUR 4.13) |

**Sources disagree on the paid tiers** (one comparison quoted Számlázz.hu Alap ~3,900 HUF/mo and Billingo Starter ~3,200 HUF/mo; all sources hedge with "kb."). **Treat every paid-tier number as indicative only — QUOTE REQUIRED** from https://www.billingo.hu/arak and the Számlázz.hu pricing page.
...
**If a DRS deposit line ever appears on your invoice, extra wording is required — confirm with the bookkeeper.** SEARCH-VERIFIED, https://www.naturasoft.hu/kornyezetvedelmi_termekdij.php

---

## 9. THE OTHER TAXES — SHORT, BECAUSE THEY ARE SMALL

### 9.1 KATA — **DELETE IT FROM THE OPTION SET**
...
> **KATA cannot be used for this business.** Selling cans to gyms, studios, clubs or supplement stores is B2B invoicing to legal persons. **A single such invoice destroys KATA status.** It is also incompatible with the secondary-occupation structure you actually want. **Remove it entirely.**

### 9.2 TAO vs KIVA (companies only)

| | TAO | KIVA |
|---|---|---|
| Rate | **9%** — lowest headline corporate rate in the EU | **10%** |
| Base | positive tax base | personnel expenses + approved dividend and capital movements (**not** profit) |
| Minimum base | **jövedelem-(nyereség-)minimum = 2% of corrected total revenue** → effective floor **0.18% of revenue** (0.09 × 0.02) | — |
| Exception | does **not** apply in the *előtársasági* year and the following tax year | — |
...
|---|---|---|---|
| ≤ 12,000,000 HUF | 2,500,000 | **50,000 HUF** | 138 |
...
| Entity / regime | HUF/month | EUR/month | EUR/year |
|---|---|---|---|
| Egyéni vállalkozó (non-KATA) | **17,000 – 35,000** | 47 – 96 | 562 – 1,157 |
| **Micro Kft.** ("Kft. könyvelése 40,000 Ft-tól indul") | **30,000 – 70,000+** | 83 – 193+ | 992 – 2,314+ |
| Small business, Budapest | 40,000 – 60,000 | 110 – 165 | 1,322 – 1,983 |
| Small business, provincial city | 25,000 – 45,000 | 69 – 124 | 826 – 1,488 |

**SEARCH-VERIFIED** (published price lists). Add **+30–40%** for year-end close, payroll and ad-hoc filings.

> **A micro Kft. in years 1–2 is on monthly VAT + monthly A60 + quarterly EPR + annual TAO + annual HIPAK + annual beszámoló. Budget the upper half: 45,000–70,000 HUF/month = EUR 124–193/month = EUR 1,488–2,314/year. That single line is 1.5×–2.3× your entire personal capital.** This is the strongest financial argument for Track A.
>
> **⚠ A1 and A2 give different EV bookkeeping ranges** — A1 says 10,000–30,000 HUF/mo, A2 says 17,000–35,000 HUF/mo. Both are list-price scrapes. **Budget A2's higher range and get a written quote.**

**When you request a quote, demand this exact scope in writing:** monthly ÁFA · monthly 'A60 (if any intra-EU) · quarterly EPR · NETA (if a caffeine SKU ever launches) · annual TAO · annual **26HIPAK** · annual beszámoló · payroll for one employee. **Do not accept a headline "from 30,000 HUF" without it.**

---

## 10. PRODUCT LEVIES — NETA, TERMÉKDÍJ, EPR, DRS

### 10.1 NETA (népegészségügyi termékadó) — **0 HUF on your SKU, because you dropped caffeine**
...
**The residual risk, bounded (DERIVED):** some sources indicate a sweetener-only limb at **8 Ft/l**, and one places the general threshold at **5 g/100 ml** rather than 8. **The sources conflict — NEEDS PROFESSIONAL CONFIRMATION.**
- Worst case at 8 Ft/l: 8 × 0.33 = **2.64 HUF/can (EUR 0.0073)**
...
> *"A termékdíj szabályozást érintő, **2025. január 1-jén hatályba lépett módosítással megszűnt a csomagolószereket terhelő termékdíj-kötelezettség.**"*

**Rate on aluminium beverage packaging in 2026: 0 Ft/kg = 0 HUF per can. Status: SEARCH-VERIFIED — NEEDS PROFESSIONAL CONFIRMATION**, because a residual termékdíj obligation still exists for other streams (tyres, batteries, electronics, oils, plastic carrier bags) and **a registration/reporting duty may survive even where the rate is 0**. Verify: NAV Információs füzet 48 (2026-01-23) https://nav.gov.hu/pfile/file?path=%2Fugyfeliranytu%2Fnezzen-utana%2Finf_fuz%2F2026%2F48.-Kornyezetvedelmi-termekdij-2026.-01.-23

**Do not conflate termékdíj with EPR.** Termékdíj taxed the packaging *material*; **EPR** charges for the packaging *actually placed on the market*. With the packaging termékdíj abolished, **EPR is the only packaging levy that remains.**

### 10.3 EPR — small money, real paperwork. **You DO need to register.**

**Legal basis 33/2025. (XI. 28.) EM rendelet** (Magyar Közlöny 2025/142), in force from 2026-01-01; **2026 rates unchanged from 2025-10-01.**

| Stream | Code | 2026 rate | EUR/kg |
|---|---|---|---|
| **Metal packaging** | **V01** | **186 HUF/kg** | 0.512 |
| Paper / cardboard | P01 | 173 HUF/kg | 0.477 |
| Plastic | M01 | 219 HUF/kg | 0.603 |

**Status: SEARCH-VERIFIED** (consistent trade-press reporting of the rendelet, not the gazette text). **The 186 Ft/kg metal figure should be re-checked against the rendelet, and it must be confirmed whether ALUMINIUM carries a separate code from ferrous metal. NEEDS PROFESSIONAL CONFIRMATION.** https://hu.andersen.com/hu/hirek/2026-os-epr-dijak/ ; MOHU hub https://mohu.hu/hu/epr-rendszer

**Per-can effect (ESTIMATE; empty can weight is UNKNOWN — QUOTE REQUIRED from Opre Label / Bubee / the can supplier; industry typical 13–15 g):**

| Can weight | Calculation | EPR/can |
|---|---|---|
| 13 g | 0.013 × 186 | **2.42 HUF / EUR 0.0067** |
| 14 g | 0.014 × 186 | **2.60 HUF / EUR 0.0072** |
| 15 g | 0.015 × 186 | **2.79 HUF / EUR 0.0077** |

**Secondary packaging is separately reportable and is NEVER DRS-exempt.** A ~350 g shipper holding 24 cans → 0.35 × 173 = **60.55 HUF/case = 2.52 HUF/can (EUR 0.0069)**. **ESTIMATE.**
...
4. **Quarterly EPR return via OKIRkapu, due by the 20th of the month after the quarter**
5. OKIR forwards to MOHU by the 25th; **MOHU invoices, payable within 15 days**

**Fines for EPR non-compliance were increased alongside the October 2025 rate rise. Exact amounts: UNKNOWN — QUOTE REQUIRED.**

> **ASK OPRE LABEL AND BUBEE THIS IN THE RFQ — it may save you the entire registration:**
> **"Ki minősül a csomagolás első forgalomba hozójának (EPR-kötelezettnek) ebben a konstrukcióban — Önök vagy mi? Vállalják-e az EPR regisztrációt és a negyedéves adatszolgáltatást?"**
...
| Levy | Per can |
|---|---|
| ÁFA | 27%, passed through — neutral in B2B |
| NETA | **0 HUF** (LIKELY; bounded worst case 2.64–7.59 HUF) |
...
## 12. WHERE THE TWO DOSSIERS DISAGREE, AND HOW TO SETTLE IT
...
| 5 | **Online Számla: is B2C invoice reporting mandatory in 2026?** One 2026 blog says no; practice since 2021-01-04 says everything is reported with the private buyer masked. | **Use software that reports everything.** Over-reporting is not penalised; under-reporting is, at up to 1,000,000 HUF per invoice. |
| 6 | **FX: dossiers use 363.28 HUF/EUR; this project's master rate is 363.** | Immaterial (0.08%). **This file uses 363 throughout, per the master.** |
| 7 | **A2 §15's per-can levy table assumes a caffeine SKU exists.** | **The agreed plan has NO caffeine SKU in batch 1.** All NETA lines are 0. The caffeine arithmetic is preserved in §10.1 as a rule for later, not as a batch-1 cost. |

---

## 13. OPEN ITEMS — WHAT MUST BE CONFIRMED OR QUOTED

**Take these to an ügyvéd and a könyvelő. Do not file anything that depends on an unconfirmed line.**

**Legal (ügyvéd):**
1. Verbatim text of **Evectv. 3. § (2)** and **Ptk. 3:22 § (1), 2:12 §, 2:15 §** at https://njt.hu / https://net.jogtar.hu
2. Whether **gyámhatóság approval** is needed for a minor to **acquire** a Kft. üzletrész at founding, and the current HUF threshold in **Gyer. 149/1997. (IX. 10.) Korm. r.**
3. Whether an **eseti gyám** is needed if father and son are on opposing sides
4. Whether a **wholesale-only / e-commerce-only** beverage business needs a **210/2009. Korm. r. kereskedelmi bejelentés**
5. Whether the **DRS small-emitter carve-out** genuinely covers your configuration — **get it in writing before the sleeve goes to print**

**Tax and accounting (könyvelő):**
6. **VTSZ/CN classification** of the final ARCH F formulation → 27% or (if milk-based) 18%. Consider a **kötelező érvényű vámtarifa-besorolás**
...
14. **Exact 2026 NETA Ft/litre rates** from NAV leaflet 53 (2026-01-23), and whether a sweetener-only drink is taxable
15. Whether the **186 Ft/kg metal EPR rate applies to aluminium** or aluminium has a separate code in 33/2025. (XI. 28.) EM rendelet
16. Whether a **small-quantity EPR exemption** exists
17. Exact **TEÁOR'25 / ÖVTJ'25 code numbers** from https://www.ksh.hu/osztalyozasok_ovtj25 before filing
18. Whether chamber registration is really due **within 5 working days** of starting, and whether the 5,000 HUF is pro-rated in year 1

**Quotes to obtain (money you cannot plan without):**
19. **Product liability + recall insurance premium** — Colonnade, CIG Pannónia, biztositson.hu
...
27. Whether **any Hungarian bank will onboard a business whose beneficial owner is under 18** — expect refusal

---

# 14. DO THIS IN THIS ORDER

**Weeks 0–1 — settle the vehicle. Spend nothing.**

1. **Ask the family: is there an existing adult-owned Kft., Bt. or EV we can use?** Pull its cégkivonat at **https://e-cegjegyzek.hu** (free). Check its registered activities and ÁFA status. → **If YES, you are on TRACK A and your year-one legal cost is EUR 0–165. Skip to step 4.**
2. **If NO:** confirm the father holds a **≥36 h/week employment**. → If yes, TRACK B (secondary-occupation EV, ≈ EUR 510/yr). **If no, DO NOT register a full-time EV — it costs EUR 280/month with zero revenue.** Go back to step 1 and widen the family search (uncle, grandparent, family friend).
3. **Book 60 minutes with an ügyvéd and 60 minutes with a könyvelő.** Take §13 with you. Cost: ask for a fixed consultation fee up front. **Do not found anything before this meeting.**

**Weeks 1–2 — the long pole and the vehicle in parallel.**

4. **START THE FOOD-BUSINESS NOTIFICATION + FELIR TODAY.** Járási hivatal / https://portal.nebih.gov.hu/hu/egyeb-bejelentes. **0 HUF. 2–4 weeks. It is the longest lead time in the whole project and everything else is faster than it.**
5. **Track A:** add TEÁOR **4634** and **4725** via NAV **26T201T** (or **26T101E**). **0 HUF, 1–3 days.** Copy the exact code numbers from **https://www.ksh.hu/osztalyozasok_ovtj25** first — **do NOT register the abolished 4791.**
   **Track B:** father gets **DÁP** (https://dap.gov.hu/, 0 HUF, 1 day) → registers at **https://ugyfelportal.nav.gov.hu/vallalkozoi-ugyseged/main** (**0 HUF, same day, adószám issued in the process**). **Not nyilvantarto.hu — it closed to new applications on 2026-03-01.**
6. **Elect NORMAL VAT.** Do **not** tick alanyi adómentesség unless every one of the four tests in §5.3 says otherwise. **Elect TAO, not KIVA.**
7. **Track B only: open the Gránit Vállalkozói KamatPlusz account** (https://granitbank.hu/vallalati-ugyfelek/bankszamlak, **0 HUF/month**). **Mandatory within 15 days of the adószám. Revolut/Wise alone is not enough.**

**Weeks 2–3 — compliance scaffolding.**

8. **Chamber registration + 5,000 HUF (EUR 13.8)** at **https://knyr.mkik.hu/** — MKIK account **12100011-10639683**, reference = the **11-digit tax number**. **Annual deadline 31 March.**
9. **Engage the bookkeeper on the written scope in §9.6.** Get three quotes. Budget **17,000–35,000 HUF/month (EUR 47–96)** for an EV.
10. **Set up free invoicing:** Számlázz.hu `#free`, Billingo Free, or **NAV Online Számlázó**. **0 HUF.** Test-issue one invoice and confirm it lands in Online Számla.
11. **🚨 DECIDE THE PÉNZTÁRGÉP QUESTION BEFORE 1 SEPTEMBER 2026 — that is 16 days from today.** Structure batch 1 as **consignment: the gym sells, you invoice the gym monthly.** That is pure B2B and needs **no cash register, no hardware, 0 HUF.** If you will ever hand a can to a person for cash, **you must issue a full számla for every single sale** — never a hand-written receipt.
12. **EPR: ask Opre Label and Bubee in the RFQ who is the EPR-obligated *gyártó*.** If it is you: register **KÜJ → OKIRkapu → MOHU** (https://mohu.hu/pdf/EPR-regisztracio.pdf). **Quarterly return by the 20th of the month after the quarter.** Fee ≈ **8,704 HUF (EUR 24)** on batch 1.
...
**Ongoing calendar — put these in your phone now.**

| Date | What |
|---|---|
| **20th of each month** | ÁFA return + payment (+ 'A60 if any intra-EU) |
| **20 Jan / 20 Apr / 20 Jul / 20 Oct** | EPR quarterly return via OKIRkapu |
| **31 March** | Kamarai hozzájárulás, 5,000 HUF |
| **31 May** | **26HIPAK** return (run BOTH the normal and the banded base — the normal base saved 45,304 HUF on batch-1 numbers) + beszámoló filing (companies) |
| **Running** | **Cans placed on the market this calendar year. Hard stop at 5,000.** |

---

*Compiled 2026-08-16 from dossiers A1 (Hungarian business setup) and A2 (Hungarian tax, VAT, invoicing). Every URL above was surfaced by web search on that date under a network policy that blocked direct access to all primary sources. No verbatim statute text was read. Spot-check every figure against the linked NAV leaflet or gazette before using it in a binding filing or financial model.*
