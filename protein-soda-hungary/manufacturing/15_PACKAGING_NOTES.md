...
**Companion to `15_PACKAGING_SUPPLIERS.csv`.** FX: **1 EUR = 363 HUF**. Batch 1 = **~1,700 cans**, landed COGS **~491 HUF (EUR 1.35)/can**, RRP **799 HUF (EUR 2.20)**.
...
| **~25,000** | Wholesale becomes viable (below it, a 470 HUF wholesale price loses 21 HUF/can against 491 HUF COGS) | DERIVED |
...
**Printed cans do not sit on this curve at all.** Their minimum order is 150,000–250,000 pieces. That is not a large setup fee to amortise; it is a wall. At the batch-1 landed COGS of ~491 HUF/can:

- 150,000 printed cans ⇒ **~73,650,000 HUF (EUR 202,900)** of production — **88× batch 1**
- 250,000 printed cans ⇒ **~122,750,000 HUF (EUR 338,200)** of production — **147× batch 1**
...
Below ~5,000 cans a year the product very probably needs **no DRS mark on the artwork** (LIKELY — NEEDS PROFESSIONAL CONFIRMATION). Above it, the mark is mandatory. **Print DRS-less artwork onto metal and you have hard-capped that inventory at 5,000 units forever.** Print the mark on, and you have committed to the deposit system, the MOHU registration and the deposit float before you know whether the product sells. A sleeve costs a reprint; a can costs the whole can. **You print 1,700 non-DRS sleeves now and, when volume justifies it, DRS sleeves for the same blank cans — scrapping zero cans.**
